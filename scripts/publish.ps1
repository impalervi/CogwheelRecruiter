param(
    ...
    [string]$TocPath = (Join-Path (Join-Path $PSScriptRoot '..') 'CogwheelRecruiter.toc')
)
...
$addonFolderName = Split-Path -Path $repoRoot -Leaf
...
try {
    ...
    Write-Host "Staging addon files from: $repoRoot"
